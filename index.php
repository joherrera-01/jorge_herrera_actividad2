        ...
        <div class="col-md-5 col-lg-4">
            <div class="card shadow p-4">
                <div class="card-body">
                    ...
                    <a href="/jorge_herrera_actividad2/public/productos.php" class="btn btn-primary btn-lg w-100 mt-3">Ir a Productos</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-5 col-lg-4">
            <div class="card shadow p-4">
                <div class="card-body">
                    ...
                    <a href="/jorge_herrera_actividad2/public/ventas.php" class="btn btn-success btn-lg w-100 mt-3">Ir a Ventas</a>
                </div>
            </div>
        </div>
    </div>
...
<footer class="text-center py-3 border-top mt-auto">
    <p class="mb-0">&copy; 2026 Jorge Herrera - Todos los derechos reservados</p>
</footer>
